...
public class Vector {
   ...
   *
   * <p>This method modifies the current vector by multiplying each component (i and j) by the given
   * scalar value.
   *
   ...
   *
   * <p>The dot product of two vectors is a scalar value that represents the product of their
   * magnitudes and the cosine of the angle between them. It is calculated as the sum of the product
   * of corresponding components of the two vectors.
   *
   ...
   *
   * <p>The magnitude of a vector is a non-negative scalar value that represents the length of the
   * vector. It is calculated as the square root of the sum of the squares of its components (i and
   * j).
   *
   ...
   *
   * <p>This method modifies the current vector by setting the i-component to the given value.
   *
   ...
   *
   * <p>This method modifies the current vector by setting the j-component to the given value.
   *
  ...
  public Translation2d getClosestPointOnLine(
      Translation2d pointOnLine, Translation2d pointOffLine) {
    Vector toPoint =
        new Vector(
            pointOffLine.getX() - pointOnLine.getX(), pointOffLine.getY() - pointOnLine.getY());
