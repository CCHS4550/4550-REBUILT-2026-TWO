...
public class SwerveSubsystem extends SubsystemBase {
  ...
  private double teleopVelocityCoefficient = 0.5;
  ...
  private void setSpeedModes() {
    ...
    if (controller.rightBumper().getAsBoolean()) {
      teleopVelocityCoefficient = 0.1;
      rotationVelocityCoefficient = 0.1;
    } else if (controller.leftBumper().getAsBoolean()) {
      teleopVelocityCoefficient = 0.25;
      rotationVelocityCoefficient = 0.25;
    } else {
      teleopVelocityCoefficient = 0.5;
      rotationVelocityCoefficient = 0.5;
    }
  }
